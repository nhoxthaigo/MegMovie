        ...
        fetch(`https://phimapi.com/danh-sach/phim-moi-cap-nhat?page=${page}`)
            ...
            .then(data => {
                ...
                data.items.forEach(element => {
                    slide += ` <div class="swiper-slide"><img src="${element.thumb_url}" alt="${element.name}"></div>`
                    html += `
            ...
            .then(() => {
                const filmCards = this.container.querySelectorAll('.film-card');
...
const moviePagination = new MoviePagination('.row', '#pagination');
